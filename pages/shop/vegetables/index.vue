<template>
  <div>
    <HeaderHeader2 />
    <ShopVegetablesSlider />
    <ShopVegetablesServices />
    <ShopVegetablesProduct_slider :products="products" @openQuickview="showQuickview" @openCompare="showCoampre" @openCart="showCart" />
    <ShopVegetablesBanner />
    <ShopVegetablesSpecial_products :products="products" :category="category" @openQuickview="showQuickview" @openCompare="showCoampre" @openCart="showCart" />
    <ShopVegetablesBlog :blog="blog" />
    <Footer />
