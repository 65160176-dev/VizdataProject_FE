            ...
            <form class="theme-form" v-on:submit="checkForm1" method="post">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <input type="tel" class="form-control" id="phone" v-model="phone" placeholder="Enter your number"
                    name="phone" required />
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-12">
                  ...
                  <textarea class="form-control" placeholder="Write Your Message" id="message" v-model="message"
    ...
    <section class="contact-page register-page section-b-space">
      <div class="container">
        <div class="row">
          <div class="col-12">
            <h3>{{ title2 }}</h3>
            <form class="theme-form" v-on:submit="checkForm2" method="post">
              <div class="row">
                <div class="col-md-6">
