        ...
        >
          <div class="container-fluid px-4">
            ...
            <div class="product-grid">
              <div
                v-for="(prod, idx) in relatedProducts"
                :key="'related-' + idx"
                class="product-card"
              >
                <div class="card h-100 shadow-sm">
                  <div
                    class="card-img-wrap"
                    @click="navigateToProduct(prod._id || prod.id)"
                  >
                    <img
    ...
    async fetchProductDetail() {
      try {
        ...
        const response = await $fetch(
          `https://vizdataprojectbe-production.up.railway.app/api/product/${productId}`,
        );
        ...
        if (this.product.userId && this.$route.query.hideSeller !== "true") {
          try {
            const sellerResponse = await $fetch(
              `https://vizdataprojectbe-production.up.railway.app/api/sellers/by-user/${this.product.userId}`,
            );
