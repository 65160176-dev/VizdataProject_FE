      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="slide-7 no-arrow slick-instagram">
            <swiper :breakpoints="swiperOption?.breakpoints" :slidesPerView="7" :spaceBetween="0" :loop="true" >
              <swiper-slide class="swiper-slide" v-for="(item, index) in image" :key="index">
                <a href="#">
