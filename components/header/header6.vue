<template>
  <div>
    <header class="header-5" :class="{ 'header5-absolute': $route.name == 'shop-jewellery' }">
                  ...
                  <ul class="header-dropdown">
                    ...
                    <li class="onhover-dropdown mobile-account">
                      ...
                      <ul class="onhover-show-div">
                        <li>
                          <nuxt-link :to="{ path: '/page/auth/LoginPage' }">Login</nuxt-link>
                        </li>
                        <li>
                  ...
                  <div class="icon-nav">
                    <ul>
                      <li class="onhover-div mobile-search">
                        <div>
                          <img src="/images/jewellery/icon/search.png" @click="openSearch()" class="img-fluid" alt />
                      ...
                      <li class="onhover-div mobile-setting">
                        <div>
                          <img src="/images/jewellery/icon/controls.png" class="img-fluid" alt />
